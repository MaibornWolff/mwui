 ...
 */
import { i as Build, g as getElement, r as registerInstance, h, e as Host } from './index-a62bab22.js';
...
const mwPopoverCss = ":host{display:block}.mw-popover-content{visibility:hidden;position:absolute;box-shadow:0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12);padding:12px;background:var(--mw-component-menu-item-bg-default);border-radius:var(--mw-component-menu-item-border-radius);border-width:var(--mw-component-menu-item-border-width-default)}.mw-popover-content.no-padding{padding:0}.mw-popover-content.open{visibility:visible;position:relative;z-index:999}";
...
const MwPopover = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: "mw-popover" }, h("div", { "aria-describedby": this.name, onClick: this.onClick, ref: el => {
        this.anchorRef = el;
      } }, h("slot", { name: "anchor" })), h("div", { role: "tooltip", id: this.name, class: classnames("mw-popover-content", { "open": this.open, "no-padding": this.noPadding }), ref: el => {
        this.contentRef = el;
      } }, h("slot", { name: "content" })))));
  }
...
__decorate([
  ClickOutside()
], MwPopover.prototype, "toggleIfOpen", null);
MwPopover.style = mwPopoverCss;

export { MwPopover as mw_popover };
