...
const MwIconGallery = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: "gallery-toolbar" }, h("mw-textfield", { class: "gallery-filter", onInput: this.onInput, placeholder: "Type to filter icons", id: "icon-filter" }, h("mw-icon", { icon: "search", slot: "icon-start" })), h("div", null, h("input", { onInput: this.onWeightChange, type: "range", id: "weight", name: "weight", min: "100", max: "700", step: "100", value: this.weight }), h("label", { htmlFor: "weight" }, "Weight: ", this.weight)), h("mw-switch", { class: "toggle-fill", label: "filled styles", onInput: this.onToggleFill })), h("div", { class: "hint" }, h("mw-icon", { icon: "content_copy", size: "small" }), "Click item to copy icon name."), h("div", { class: "gallery" }, this.filteredIcons.map(iconName => (h("div", { class: `gallery-item-container ${iconName}`, onClick: () => this.copyIconName(iconName) }, h("div", { class: "gallery-item" }, h("mw-icon", { fill: this.fill, icon: iconName, weight: this.weight, size: "large" }), h("p", { class: "gallery-item-text" }, iconName.split("_").join(" ")))))))));
  }
};
MwIconGallery.style = mwIconGalleryCss;

export { MwIconGallery as mw_icon_gallery };
