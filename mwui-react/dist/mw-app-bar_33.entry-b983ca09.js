...
const MwAppBar = class {
    ...
    render() {
        return index.h(
            ...
            index.h(
                "div",
                { class: `mw-app-bar ${this.position}`, role: this.ariaRole },
                index.h("slot", { name: "start" }),
                index.h("slot", { name: "center" }),
        ...
        return index.h(
            ...
            index.h(
                ...
                index.h(
                    ...
                    index.h("mw-label", { name: this.name, label: this.label, required: this.required }),
                    index.h(
                        "mw-popover",
                            ...
                            ? index.h(
                                  ...
                                  this.hasIconStartSlot &&
                                      index.h(
                                          ...
                                          index.h("slot", { name: "icon-start" }),
                                      ),
                                  index.h("mw-icon", { slot: "icon-end", icon: this.isDropdownOpen ? "keyboard_arrow_up" : "keyboard_arrow_down", size: "medium" }),
                              )
                            : index.h(
                                  "mw-textfield",
                                  {
                                  ...
                                  index.h(
                                      ...
                                      index.h("mw-icon", { icon: this.isDropdownOpen ? "keyboard_arrow_up" : "keyboard_arrow_down", size: "medium" }),
                                  ),
                              ),
                        index.h(
                            "div",
                            { slot: "content" },
                            this.canAddToValues() ? index.h("slot", { name: "dropdown-menu" }) : index.h("div", { class: "maximum-reached" }, this.maximumText),
                            index.h("div", { ref: el => (this.noSuggestionsDisclaimer = el), class: "no-suggestions" }, this.noSuggestionsText),
                        ),
                    ),
                ),
                index.h(
                    ...
                    this.maximum && this.optionCounter && index.h("mw-helper-text", { helperText: `${this.selection.length}/${this.maximum}` }),
                ),
            ),
        );
    }
    ...
    render() {
        return index.h(
            ...
            index.h(
                ...
                this.alt && index.h("div", { class: `fallback ${this.size}` }, this.alt.substring(0, 1)),
                this.src && index.h("img", { src: this.src, alt: this.alt }),
                this.icon && index.h("mw-icon", { icon: this.icon, size: this.size }),
            ),
        );
    }
};
...
const MwCardHeader = class {
    ...
    render() {
        return index.h(
            ...
            index.h("div", { class: "text" }, index.h("div", { class: "header" }, this.header), index.h("div", { class: "subheader" }, this.subheader)),
        );
    }
};
    ...
    render() {
        return index.h(
            ...
            index.h(
                ...
                index.h("img", { src: this.src, alt: this.alt, style: this.styles }),
            ),
        );
    }
    get hostElement() {
    ...
    render() {
        return index.h(
            ...
            index.h(
                "div",
                { class: "card-title" },
                index.h("div", { class: "metadata" }, this.metadata),
                index.h("div", { class: "title" }, this.text),
                index.h("div", { class: "subtitle" }, this.subtitle),
            ),
        );
    }
};
...
const MwCheckbox = class {
    ...
    render() {
        return index.h(
            ...
            index.h("input", { type: "checkbox", checked: this.checked, value: this.value, name: this.name }),
            index.h(
                "span",
            ...
            index.h("san", { class: "mw-checkbox-label" }, this.label),
        );
    }
    ...
    render() {
        return index.h(
            ...
            index.h(
                ...
                !!this.icon && index.h("mw-icon", { icon: this.icon, size: "small" }),
                index.h("slot", null),
                this.showClose && index.h("span", { onClick: this.handleClose }, index.h("mw-icon", { icon: "close", color: "currentcolor", size: "small" })),
            ),
        );
    }
};
        ...
        return index.h(
            ...
            index.h(
                ...
                index.h(
                    ...
                    index.h("mw-label", { name: this.name, label: this.label, required: required }),
                    index.h(
                        "div",
                        {
                            slot: "anchor",
                        ...
                        this._selection.hasValues() &&
                            index.h("span", { class: "icon-close-multiple", onClick: clearMultiValues }, index.h("mw-icon", { icon: "close", size: "medium" })),
                        index.h(
                            "div",
                            {
                                class: {
                ...
                index.h(
                    "div",
                    { class: "helper-text-container" },
                    index.h("mw-helper-text", { helperText: helperText, hasError: hasError }),
                    this.maximum && optionCounter && index.h("mw-helper-text", { helperText: `${this.selected.length}/${maximum}` }),
                ),
            ),
        );
    }
            ...
            index.h(
                ...
                index.h(
                    ...
                    index.h(
                        ...
                        index.h("div", { slot: "content" }, index.h("slot", { name: "dropdown-menu" })),
                    ),
                    !this.inline && index.h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }),
                ),
                this.inline && index.h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }),
            ),
        );
        ...
        return index.h(
            ...
            index.h(
                ...
                index.h(
                    ...
                    index.h("mw-icon", { icon: "search", slot: "icon-start" }),
                ),
                index.h("mw-slider", {
                    inline: true,
                    label: "Weight",
                ...
                index.h("mw-switch", { class: "toggle-fill", label: "filled styles", onInput: this.onToggleFill }),
            ),
            index.h("div", { class: "hint" }, index.h("mw-icon", { icon: "content_copy", size: "small" }), "Click item to copy icon name."),
            index.h(
                "div",
                { class: "gallery" },
                this.filteredIcons.map(iconName =>
                    index.h(
                        ...
                        index.h(
                            "div",
                            { class: "gallery-item" },
                            index.h("mw-icon", { fill: this.fill, icon: iconName, weight: this.weight, size: "large" }),
                            index.h("p", { class: "gallery-item-text" }, iconName.split("_").join(" ")),
                        ),
                    ),
                ),
            ),
...
const MwLabel = class {
    ...
    render() {
        ...
        return index.h(
            index.Host,
            { role: "label", class: "mw-label" },
            !!label && index.h("label", { htmlFor: name, class: "label" }, label, required && index.h("span", { class: "required" }, "*")),
        );
    }
};
            ...
            index.h(
                ...
                this.backgroundImage &&
                    ...
                    index.h(
                        ...
                        index.h("img", { class: "mw-login-background__image", src: this.backgroundImage }),
                    ),
                index.h(
                    "div",
                    { class: `mw-login-container mw-login-container--${this.layout}` },
                    this.logo && index.h("div", { class: "mw-login-container__logo" }, index.h("img", { src: this.logo })),
                    this.headline && index.h("div", { class: "mw-login-container__headline" }, this.headline),
                    index.h(
                        "form",
                        ...
                        index.h(
                            ...
                            index.h("mw-icon", { icon: "mail", slot: "icon-end" }),
                        ),
                        index.h(
                            "mw-textfield",
                            {
                            ...
                            index.h("mw-icon", { icon: this.passwordType === "text" ? "visibility_off" : "visibility", slot: "icon-end", onClick: this.togglePasswordType }),
                        ),
                    ),
                    index.h(
                        "div",
                        { class: "mw-login-container__user-actions" },
                        index.h("mw-checkbox", { label: "Remember me" }),
                        index.h("span", { class: "spacefiller" }),
                        this.forgotPasswordHref && index.h("mw-link", { href: this.forgotPasswordHref }, "Forgot your password?"),
                    ),
                    index.h("mw-button", { label: "Log In", onClick: this.submitLoginForm, id: "submit" }),
                    this.signUpHref &&
                        index.h(
                            "div",
                            ...
                            " ",
                            index.h("mw-link", { href: this.signUpHref, underline: true }, "Sign up"),
                        ),
                ),
            ),
        );
    ...
    render() {
        return index.h(
            ...
            index.h(
                ...
                index.h("div", { slot: "anchor" }, index.h("slot", { name: "anchor" })),
                index.h("div", { slot: "content", class: "menu" }, index.h("slot", null)),
            ),
        );
    }
};
    ...
    render() {
        return index.h(
            ...
            index.h(
                ...
                !!this.text && index.h("div", { class: "mw-menu-item-title" }, this.text),
                !!this.subtitle && index.h("div", { class: "mw-menu-item-subtitle" }, this.subtitle),
            ),
        );
    }
};
...
const MwRadio = class {
    ...
    render() {
        return index.h(
            ...
            index.h("input", { id: this.radioId, type: "radio", value: this.value, name: this.name, checked: this.checked, disabled: this.disabled }),
            index.h("span", { class: "mw-radio" }),
            index.h("label", { class: "mw-radio-label", htmlFor: this.radioId }, this.label),
        );
    }
    get hostElement() {
        return index.getElement(this);
        ...
        return index.h(
            ...
            index.h(
                ...
                index.h(
                    ...
                    this.label && index.h("label", { class: "mw-slider-label", htmlFor: this.name }, this.label),
                    index.h(
                        "div",
                        { class: { "mw-slider-input-wrapper": true, "disabled": this.disabled } },
                        this.startIcon && index.h("mw-icon", { icon: this.startIcon, size: "medium" }),
                        index.h(
                            "div",
                            ...
                            index.h("label", { htmlfor: this.name, id: "mw-slider-range-value" }, this.value),
                        ),
                        this.endIcon && index.h("mw-icon", { icon: this.endIcon, size: "medium" }),
                    ),
                    this.helperText && !this.inline && index.h("div", { class: "mw-slider-helper" }, this.helperText),
                ),
                this.helperText && this.inline && index.h("div", { class: "mw-slider-helper" }, this.helperText),
            ),
        );
    ...
    render() {
        return index.h(
            ...
            index.h(
                ...
                index.h("input", { disabled: this.disabled, type: "checkbox", onInput: this.toggleSwitch, checked: this.checked }),
                index.h("span", { class: "slider round" }),
            ),
            this.hasLabel && index.h("span", { class: "label" }, this.label),
            this.hasOnOffLabel && index.h("span", { class: "label" }, this.checked ? this.on : this.off),
        );
    }
};
    ...
    render() {
        return index.h(
            ...
            this.tabs.map((item, key) =>
                index.h("mw-tab", { key: key, icon: item.icon, label: item.label, selected: item.selected, disabled: item.disabled, onClick: () => this.handleClick(key) }),
            ),
        );
    }
    get host() {
