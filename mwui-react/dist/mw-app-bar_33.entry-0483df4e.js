import { r as registerInstance, h, H as Host, c as createEvent, g as getElement } from "./index-3847b4d2.js";
...
const MwAppBar = class {
    ...
    render() {
        return h(
            Host,
            null,
            h("div", { class: `mw-app-bar ${this.position}`, role: this.ariaRole }, h("slot", { name: "start" }), h("slot", { name: "center" }), h("slot", { name: "end" })),
        );
    }
};
MwAppBar.style = mwAppBarCss;

const mwAppBarTitleCss =
    ":host .mw-app-bar-title{color:var(--mw-component-header-fg-default);font-family:var(--mw-component-header-title-font-family);font-weight:var(--mw-component-header-title-font-weight);line-height:var(--mw-component-header-title-line-height);font-size:var(--mw-component-header-title-font-size)}";
...
const MwAutocomplete = class {
    ...
    render() {
        return h(
            ...
            h(
                "div",
                { tabindex: "0", class: "wrapper", role: AriaRolesEnum.COMBOBOX },
                h(
                    "div",
                    {
                        class: {
                    ...
                    h("mw-label", { name: this.name, label: this.label, required: this.required }),
                    h(
                        "mw-popover",
                        { noPadding: true, closeOnClick: true, open: this.isDropdownOpen, dismissable: this.isDropdownOpen, disabled: this.disabled },
                        this.multiple
                            ? h(
                                  "mw-chip-input",
                                  {
                                  ...
                                  h("mw-icon", { slot: "icon-end", icon: this.isDropdownOpen ? "keyboard_arrow_up" : "keyboard_arrow_down", size: "medium" }),
                              )
                            : h(
                                  "mw-textfield",
                                  {
                                  ...
                                  h(
                                      ...
                                      h("mw-icon", { icon: this.isDropdownOpen ? "keyboard_arrow_up" : "keyboard_arrow_down", size: "medium" }),
                                  ),
                              ),
                        h(
                            "div",
                            { slot: "content" },
                            this.canAddToValues() ? h("slot", { name: "dropdown-menu" }) : h("div", { class: "maximum-reached" }, this.maximumText),
                            h("div", { ref: el => (this.noSuggestionsDisclaimer = el), class: "no-suggestions" }, this.noSuggestionsText),
                        ),
                    ),
                ),
                h(
                    ...
                    this.maximum && this.optionCounter && h("mw-helper-text", { helperText: `${this.selection.length}/${this.maximum}` }),
                ),
            ),
        );
    }
...
const MwAvatar = class {
    ...
    render() {
        return h(
            ...
            h(
                "div",
                { "test-id": this.testId, "class": `avatar ${this.size}` },
                this.alt && h("div", { class: `fallback ${this.size}` }, this.alt.substring(0, 1)),
                this.src && h("img", { src: this.src, alt: this.alt }),
                this.icon && h("mw-icon", { icon: this.icon, size: this.size }),
            ),
        );
    }
};
...
const MwCardImage = class {
    ...
    render() {
        return h(
            ...
            h(
                "div",
                { class: { "card-image": true, "top": this.isFirstChild, "bottom": this.isLastChild, "single": this.isOnlyChild } },
                h("img", { src: this.src, alt: this.alt, style: this.styles }),
            ),
        );
    }
    get hostElement() {
    ...
    render() {
        return h(
            ...
            h(
                "div",
                { class: "card-title" },
                h("div", { class: "metadata" }, this.metadata),
                h("div", { class: "title" }, this.text),
...
const MwCheckbox = class {
    ...
    render() {
        return h(
            "div",
            { "test-id": this.testId, "class": "mw-checkbox-container", "onClick": this.handleCheck },
            h("input", { type: "checkbox", checked: this.checked, value: this.value, name: this.name }),
            h(
                "span",
            ...
            h("san", { class: "mw-checkbox-label" }, this.label),
        );
    }
    ...
    render() {
        return h(
            ...
            h(
                ...
                !!this.icon && h("mw-icon", { icon: this.icon, size: "small" }),
                h("slot", null),
                this.showClose && h("span", { onClick: this.handleClose }, h("mw-icon", { icon: "close", color: "currentcolor", size: "small" })),
            ),
        );
    }
};
        ...
        return h(
            ...
            h(
                ...
                h(
                    ...
                    h("mw-label", { name: this.name, label: this.label, required: required }),
                    h(
                        "div",
                        {
                            slot: "anchor",
                            ...
                            selected === null || selected === void 0
                                ...
                                : selected.map(v =>
                                      h(
                                          ...
                                          {
                                              key: v,
                                              onMwChipClose: () => this.onRemoveSelection(v),
                                              showClose: true,
                                              value: v,
                                              selected: true,
                                              toggleable: false,
                        ...
                        this._selection.hasValues() && h("span", { class: "icon-close-multiple", onClick: clearMultiValues }, h("mw-icon", { icon: "close", size: "medium" })),
                        h(
                            "div",
                            {
                                class: {
                ...
                h(
                    "div",
                    { class: "helper-text-container" },
                    h("mw-helper-text", { helperText: helperText, hasError: hasError }),
                    this.maximum && optionCounter && h("mw-helper-text", { helperText: `${this.selected.length}/${maximum}` }),
                ),
            ),
        );
    }
...
const mwDividerCss =
    ".mw-divider{box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;border:0;border-top:var(--mw-component-divider-border-width-default) solid var(--mw-component-divider-fg-default)}.mw-divider.inset{margin:0 var(--mw-component-divider-inset)}";
    ...
    render() {
        return h(
            ...
            h(
                ...
                h(
                    "div",
                    { class: { "dropdown": true, "inline": this.inline, "has-error": this.hasError, "disabled": this.disabled } },
                    h("mw-label", { name: this.name, label: this.label, required: this.required }),
                    h(
                        "mw-popover",
                        { noPadding: true, closeOnClick: true, open: this.isDropdownOpen },
                        h(
                            "div",
                            { slot: "anchor", onClick: this.onFocus, class: { "input": true, "has-error": this.hasError, "disabled": this.disabled } },
                            h(
                                "span",
                                {
                                    class: {
                        ...
                        h("div", { slot: "content" }, h("slot", { name: "dropdown-menu" })),
                    ),
                    !this.inline && h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }),
                ),
                this.inline && h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }),
            ),
        );
...
const mwIconCss =
    '@import url("https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200");:host{display:flex}.material-symbols-outlined{font-family:"Material Symbols Outlined";display:flex;justify-content:center;align-items:center}';

const getOpticalSize = size =>
    Number(
        {
            [SizeEnum.X_LARGE]: 48,
            [SizeEnum.LARGE]: 48,
    ...
    render() {
        return h(
            ...
            h(
                ...
                h(
                    "mw-textfield",
                    { class: "gallery-filter", onInput: this.onInput, placeholder: "Type to filter icons", id: "icon-filter" },
                    h("mw-icon", { icon: "search", slot: "icon-start" }),
                ),
                h("mw-slider", { inline: true, label: "Weight", onInput: this.onWeightChange, id: "weight", name: "weight", min: 100, max: 700, step: 100, value: this.weight }),
                h("mw-switch", { class: "toggle-fill", label: "filled styles", onInput: this.onToggleFill }),
            ),
            h("div", { class: "hint" }, h("mw-icon", { icon: "content_copy", size: "small" }), "Click item to copy icon name."),
            h(
                "div",
                { class: "gallery" },
                this.filteredIcons.map(iconName =>
                    h(
                        "div",
                        { class: `gallery-item-container ${iconName}`, onClick: () => this.copyIconName(iconName) },
                        h(
                            "div",
                            { class: "gallery-item" },
                            h("mw-icon", { fill: this.fill, icon: iconName, weight: this.weight, size: "large" }),
                            h("p", { class: "gallery-item-text" }, iconName.split("_").join(" ")),
                        ),
                    ),
                ),
            ),
        ...
        return h(
            ...
            h(
                ...
                this.backgroundImage &&
                    this.layout !== LoginLayoutEnum.CENTER &&
                    h("div", { class: `mw-login-background mw-login-background--${this.layout}` }, h("img", { class: "mw-login-background__image", src: this.backgroundImage })),
                h(
                    "div",
                    { class: `mw-login-container mw-login-container--${this.layout}` },
                    this.logo && h("div", { class: "mw-login-container__logo" }, h("img", { src: this.logo })),
                    this.headline && h("div", { class: "mw-login-container__headline" }, this.headline),
                    h(
                        "form",
                        { class: "mw-login-container__form", ref: el => (this.loginForm = el) },
                        h("mw-textfield", { id: "email", name: "email", type: "email", label: "Email address", required: true }, h("mw-icon", { icon: "mail", slot: "icon-end" })),
                        h(
                            "mw-textfield",
                            {
                                "id": "password",
                            ...
                            h("mw-icon", { icon: this.passwordType === "text" ? "visibility_off" : "visibility", slot: "icon-end", onClick: this.togglePasswordType }),
                        ),
                    ),
                    h(
                        "div",
                        { class: "mw-login-container__user-actions" },
                        h("mw-checkbox", { label: "Remember me" }),
                        h("span", { class: "spacefiller" }),
                        this.forgotPasswordHref && h("mw-link", { href: this.forgotPasswordHref }, "Forgot your password?"),
                    ),
                    h("mw-button", { label: "Log In", onClick: this.submitLoginForm, id: "submit" }),
                    this.signUpHref &&
                        h("div", { class: "mw-login-container__sign-up" }, "Dont't have an account?", " ", h("mw-link", { href: this.signUpHref, underline: true }, "Sign up")),
                ),
            ),
        );
    }
...
const MwMenu = class {
    ...
    render() {
        return h(
            ...
            h(
                "mw-popover",
                { "testId": this.testId, "placement": this.placement, "open": this.open, "no-padding": true },
                h("div", { slot: "anchor" }, h("slot", { name: "anchor" })),
                h("div", { slot: "content", class: "menu" }, h("slot", null)),
            ),
        );
    }
};
...
const MwMenuItem = class {
    ...
    render() {
        return h(
            ...
            h(
                "div",
                { onClick: this.handleClick, tabindex: "0", class: { "mw-menu-item": true, "disabled": this.disabled, "selected": this.selected } },
                !!this.text && h("div", { class: "mw-menu-item-title" }, this.text),
                !!this.subtitle && h("div", { class: "mw-menu-item-subtitle" }, this.subtitle),
            ),
        );
    }
};
...
const MwRadio = class {
    ...
    render() {
        return h(
            ...
            h("input", { id: this.radioId, type: "radio", value: this.value, name: this.name, checked: this.checked, disabled: this.disabled }),
            h("span", { class: "mw-radio" }),
            h("label", { class: "mw-radio-label", htmlFor: this.radioId }, this.label),
        );
    }
    get hostElement() {
        return getElement(this);
    ...
    render() {
        return h(
            ...
            h(
                ...
                h(
                    "div",
                    { "class": { "mw-slider": true, "inline": this.inline, "disabled": this.disabled }, "test-id": this.testId },
                    this.label && h("label", { class: "mw-slider-label", htmlFor: this.name }, this.label),
                    h(
                        "div",
                        { class: { "mw-slider-input-wrapper": true, "disabled": this.disabled } },
                        this.startIcon && h("mw-icon", { icon: this.startIcon, size: "medium" }),
                        h(
                            "div",
                            ...
                            h("label", { htmlfor: this.name, id: "mw-slider-range-value" }, this.value),
                        ),
                        this.endIcon && h("mw-icon", { icon: this.endIcon, size: "medium" }),
                    ),
                    this.helperText && !this.inline && h("div", { class: "mw-slider-helper" }, this.helperText),
                ),
                this.helperText && this.inline && h("div", { class: "mw-slider-helper" }, this.helperText),
            ),
        );
...
const MwSwitch = class {
    ...
    render() {
        return h(
            ...
            h(
                "label",
                { "test-id": this.testId, "class": "switch" },
                h("input", { disabled: this.disabled, type: "checkbox", onInput: this.toggleSwitch, checked: this.checked }),
                h("span", { class: "slider round" }),
            ),
            this.hasLabel && h("span", { class: "label" }, this.label),
            this.hasOnOffLabel && h("span", { class: "label" }, this.checked ? this.on : this.off),
        );
    }
};
...
const MwTab = class {
    ...
    render() {
        return h(
            ...
            h(
                "button",
                { disabled: this.disabled, class: `mw-tab ${this.icon && this.label ? "label-with-icon" : ""} ${this.selected ? "selected" : ""}` },
                this.icon && h("mw-icon", { icon: this.icon, size: "small" }),
                this.label,
            ),
        );
...
const MwTabs = class {
    ...
    render() {
        return h(
            "div",
            { "test-id": this.testId, "class": "mw-tabs" },
            this.tabs.map((item, key) =>
                h("mw-tab", { key: key, icon: item.icon, label: item.label, selected: item.selected, disabled: item.disabled, onClick: () => this.handleClick(key) }),
            ),
        );
    }
    get host() {
        ...
        return h(
            ...
            h(
                ...
                h(
                    ...
                    h(
                        "div",
                        { onClick: this.onFocus, class: { "input": true, "has-error": this.hasError, "disabled": this.disabled } },
                        h(
                            "span",
                            { class: { "icon-start": this.hasIconStartSlot, "focused": this.focused, "has-error": this.hasError }, part: "icon-start" },
                            h("slot", { name: "icon-start" }),
                        ),
                        h("input", {
                            ref: el => (this.inputElement = el),
                        ...
                        h(
                            "span",
                            { class: { "icon-end": this.hasIconEndSlot, "focused": this.focused, "has-error": this.hasError }, part: "icon-end" },
                            h("slot", { name: "icon-end" }),
                        ),
                    ),
                    !this.inline && h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }),
...
export {
    MwAppBar as mw_app_bar,
    MwAppBarTitle as mw_app_bar_title,
    MwAutocomplete as mw_autocomplete,
    MwAvatar as mw_avatar,
    MwButton as mw_button,
    MwCard as mw_card,
    MwCardBody as mw_card_body,
    MwCardFooter as mw_card_footer,
    MwCardHeader as mw_card_header,
    MwCardImage as mw_card_image,
    MwCardTitle as mw_card_title,
    MwCheckbox as mw_checkbox,
    MwChip as mw_chip,
    MwChipInput as mw_chip_input,
    MwDivider as mw_divider,
    MwDropdown as mw_dropdown,
    MwHelperText as mw_helper_text,
    MwIcon as mw_icon,
    MwIconGallery as mw_icon_gallery,
    MwLabel as mw_label,
    MwLink as mw_link,
    MwLogin as mw_login,
    MwMenu as mw_menu,
    MwMenuItem as mw_menu_item,
    MwMenuList as mw_menu_list,
    MwPopover as mw_popover,
    MwRadio as mw_radio,
    MwSlider as mw_slider,
    MwSwitch as mw_switch,
    MwTab as mw_tab,
    MwTabs as mw_tabs,
    MwTextarea as mw_textarea,
    MwTextfield as mw_textfield,
};
