...
const MwSwitch = class {
  ...
  render() {
    return (h(Host, null, h("label", { "test-id": this.testId, class: "switch" }, h("input", { disabled: this.disabled, type: "checkbox", onInput: this.toggleSwitch, checked: this.checked }), h("span", { class: "slider round" })), this.hasLabel && h("span", { class: "label" }, this.label), this.hasOnOffLabel && h("span", { class: "label" }, this.checked ? this.on : this.off)));
  }
};
