import { r as registerInstance, h, H as Host, c as createEvent, g as getElement } from "./index-3359c25c.js";
...
const MwAutocomplete = class {
    ...
    render() {
        return h(Host, null, h("div", {
            ...
            slot: "content"
        }, this.canAddToValues() ? h("slot", {
            name: "dropdown-menu"
        }) : h("div", {
            class: "maximum-reached"
        }, this.maximumText), h("div", {
            ref: el => this.noSuggestionsDisclaimer = el,
            class: "no-suggestions"
        }, this.noSuggestionsText)))), h("div", {
            class: "helper-text-container"
        }, h("mw-helper-text", {
            helperText: this.helperText,
            hasError: this.hasError
        }), this.maximum && this.optionCounter && h("mw-helper-text", {
...
const MwAvatar = class {
    ...
    render() {
        ...
        }, this.alt.substring(0, 1)), this.src && h("img", {
            src: this.src,
            alt: this.alt
        }), this.icon && h("mw-icon", {
            icon: this.icon,
...
const MwButton = class {
    ...
    render() {
        const button = h("button", {
            ...
            name: "icon-start"
        })), h("span", null, this.label), this.hasIconEndSlot && h("span", {
            class: {
        ...
        return h(Host, null, this.href ? h("a", {
            href: this.href
        }, button) : button);
    }
    get hostElement() {
...
const MwChip = class {
    ...
    render() {
        return h(Host, null, h("div", {
            ...
            icon: this.icon,
            size: "small"
        }), h("slot", null), this.showClose && h("span", {
...
const MwChipInput = class {
    ...
    render() {
        ...
        return h(Host, null, h("div", {
            ...
            class: "input-options"
        }, selected === null || selected === void 0 ? void 0 : selected.map((v => h("mw-chip", {
            key: v,
            showClose: true,
            value: v,
            selected: true,
        ...
        })), this._selection.hasValues() && h("span", {
            ...
            helperText,
            hasError
        }), this.maximum && optionCounter && h("mw-helper-text", {
...
const MwDropdown = class {
    ...
    render() {
        return h(Host, null, h("div", {
            ...
            onFocus: this.onFocus,
            onBlur: this.onBlur
        }, this.valueLabel ? this.valueLabel : this.placeholder), h("span", {
            class: {
...
const MwIconGallery = class {
    ...
    render() {
        return h(Host, null, h("div", {
            ...
            icon: "content_copy",
            size: "small"
        }), "Click item to copy icon name."), h("div", {
            class: "gallery"
        }, this.filteredIcons.map((iconName => h("div", {
...
const MwLogin = class {
    ...
    render() {
        return h(Host, null, h("div", {
        ...
        }, this.backgroundImage && this.layout !== LoginLayoutEnum.CENTER && h("div", {
            ...
            class: "spacefiller"
        }), this.forgotPasswordHref && h("mw-link", {
            href: this.forgotPasswordHref
        }, "Forgot your password?")), h("mw-button", {
            label: "Log In",
            onClick: this.submitLoginForm,
            id: "submit"
        }), this.signUpHref && h("div", {
            class: "mw-login-container__sign-up"
        }, "Dont't have an account?", " ", h("mw-link", {
...
const MwMenu = class {
    ...
    render() {
        return h(Host, null, h("mw-popover", {
            testId: this.testId,
...
const MwSlider = class {
    ...
    render() {
        ...
        }, this.value)), this.endIcon && h("mw-icon", {
            icon: this.endIcon,
            size: "medium"
        })), this.helperText && !this.inline && h("div", {
            class: "mw-slider-helper"
        }, this.helperText)), this.helperText && this.inline && h("div", {
            class: "mw-slider-helper"
        }, this.helperText)));
    }
    get host() {
...
const MwSwitch = class {
    ...
    render() {
        return h(Host, null, h("label", {
            ...
            class: "label"
        }, this.label), this.hasOnOffLabel && h("span", {
            class: "label"
...
const MwTabs = class {
    ...
    render() {
        return h("div", {
            "test-id": this.testId,
            class: "mw-tabs"
        }, this.tabs.map(((item, key) => h("mw-tab", {
            key,
            icon: item.icon,
            label: item.label,
