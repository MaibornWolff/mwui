...
const MwAutocomplete = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.valueChanged = index.createEvent(this, "selectionChanged", 7);
...
const MwButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, this.href ? (index.h("a", { target: this.target, href: this.href }, button)) : (button)));
  }
  get hostElement() { return index.getElement(this); }
};
...
const MwCheckbox = class {
  constructor(hostRef) {
    ...
    this.JSXLabel = (index.h("label", { class: `mw-checkbox-label ${this.disabled ? "disabled" : "enabled"}`, htmlFor: this.checkboxId }, this.label));
    this.testId = undefined;
    this.value = undefined;
    this.name = undefined;
    this.checked = false;
  ...
  render() {
    return (index.h(index.Host, { "test-id": this.testId, class: `mw-checkbox-container ${this.disabled ? "disabled" : "enabled"} ${this.labelPosition}`, onClick: this.handleCheck, "aria-checked": `${this.checked}`, "aria-hidden": this.disabled ? "true" : null, role: "checkbox" }, this.label && this.labelPosition === "left" && this.JSXLabel, index.h("input", { id: this.checkboxId, type: "checkbox", checked: this.checked, value: this.value, name: this.name }), index.h("span", { class: "mw-checkbox-outer" }, index.h("span", { class: `mw-checkbox ${this.checked || this.indeterminate ? "selected" : "unselected"} ${this.disabled ? "disabled" : "enabled"}` }, index.h("mw-icon", { class: `mw-checkmark ${this.checked || this.indeterminate ? "selected" : "unselected"}`, color: `var(--mw-component-controls-color-fg-default)`, icon: this.indeterminate ? "check_indeterminate_small" : "check", size: "small" }))), this.label && this.labelPosition === "right" && this.JSXLabel));
  }
...
const MwCheckboxGroup = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.checkboxChange = index.createEvent(this, "checkboxChange", 4);
  ...
  render() {
    return (index.h(index.Host, { role: "checkboxgroup" }, index.h("mw-checkbox", { label: this.parentLabel, checked: this.checked, indeterminate: this.indeterminate, onClick: this.onParentClick }), index.h("div", { class: `mw-checkbox-group ${this.direction} ${this.wrap ? "wrap" : ""}` }, this.checkboxes.map((item, key) => (index.h("mw-checkbox", { key: key, label: item.label, disabled: item.disabled, checked: this.value.includes(item.value), value: item.value, onClick: () => this.onClick(item.value, item.disabled) }))))));
  }
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "wrapper" }, index.h("div", { class: {
      ...
      selected.map(v => (index.h("mw-chip", { key: v, onMwChipClose: () => this.onRemoveSelection(v), showClose: true, value: v, selected: true, toggleable: false, disabled: disabled }, v))), this.canAddToValues() && (index.h("input", { ref: el => (this.inputElement = el), class: {
        ...
        "focused": focused,
        "has-error": hasError,
      } }, index.h("slot", { name: "icon-end" })))), (helperText || (optionCounter && maximum)) && (index.h("div", { class: "helper-text-container" }, index.h("mw-helper-text", { helperText: helperText, hasError: hasError }), maximum && optionCounter && index.h("mw-helper-text", { helperText: `${this.selected.length}/${maximum}` }))))));
  }
  get hostElement() { return index.getElement(this); }
  static get watchers() { return {
...
const MwDropdown = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "wrapper" }, index.h("div", { class: { "dropdown": true, "horizontal": this.layout === LayoutEnum.HORIZONTAL, "has-error": this.hasError, "disabled": this.disabled } }, index.h("mw-label", { name: this.name, label: this.label, required: this.required }), index.h("mw-popover", { noPadding: true, closeOnClick: true, open: this.isDropdownOpen }, index.h("div", { slot: "anchor", onClick: this.onFocus, class: { "input": true, "has-error": this.hasError, "disabled": this.disabled } }, index.h("span", { class: {
        ...
        "focused": this.focused,
        "has-error": this.hasError,
      } }, index.h("mw-icon", { icon: this.isDropdownOpen ? "keyboard_arrow_up" : "keyboard_arrow_down", size: "medium" })))), index.h("div", { slot: "content" }, index.h("slot", { name: "dropdown-menu" }))), this.helperText && this.layout === LayoutEnum.VERTICAL && index.h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError })), this.helperText && this.layout === LayoutEnum.HORIZONTAL && index.h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }))));
  }
  get host() { return index.getElement(this); }
};
...
const MwRadio = class {
  constructor(hostRef) {
    ...
    this.JSXLabel = (index.h("label", { class: `mw-radio-label ${this.disabled ? "disabled" : "enabled"}`, htmlFor: this.radioId }, this.label));
    this.disabled = undefined;
    this.checked = false;
    this.value = undefined;
    this.name = undefined;
  ...
  render() {
    return (index.h(index.Host, { "test-id": this.testId, onClick: this.onClick, class: `mw-radio-container ${this.disabled ? "disabled" : "enabled"} ${this.labelPosition}`, "aria-checked": `${this.checked}`, "aria-hidden": this.disabled ? "true" : null, role: "radio" }, this.label && this.labelPosition === "left" && this.JSXLabel, index.h("input", { id: this.radioId, type: "radio", value: this.value, name: this.name, checked: this.checked, disabled: this.disabled }), index.h("span", { class: "mw-radio-outer" }, index.h("span", { class: "mw-radio" })), this.label && this.labelPosition === "right" && this.JSXLabel));
  }
  get hostElement() { return index.getElement(this); }
};
...
const MwRadioGroup = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.radioChange = index.createEvent(this, "radioChange", 6);
    this.onClick = (event) => {
      event.preventDefault();
  ...
  render() {
    return index.h(index.Host, { class: `mw-radio-group ${this.direction} ${this.wrap ? "wrap" : ""}`, role: "radiogroup", onClick: this.onClick });
  }
  get host() { return index.getElement(this); }
  static get watchers() { return {
    "value": ["valueChanged"]
...
const MwSwitch = class {
  constructor(hostRef) {
    ...
    this.JSXLabel = (label) => {
      return (index.h("label", { htmlFor: this.switchId }, index.h("span", { class: `mw-switch-label ${this.disabled ? "disabled" : "enabled"}` }, label)));
    };
    this.testId = undefined;
    this.disabled = undefined;
    this.label = undefined;
  ...
  render() {
    return (index.h(index.Host, { "test-id": this.testId, class: `mw-switch-container ${this.disabled ? "disabled" : "enabled"} ${this.labelPosition}`, onClick: this.toggleSwitch, "aria-checked": `${this.checked}`, "aria-hidden": this.disabled ? "true" : null, role: "switch" }, (this.hasLabel || this.hasOnOffLabel) && this.labelPosition === "left" && this.JSXLabel(this.hasOnOffLabel ? (this.checked ? this.on : this.off) : this.label), index.h("span", { class: "switch" }, index.h("input", { id: this.switchId, disabled: this.disabled, type: "checkbox", onInput: this.toggleSwitch, checked: this.checked, name: this.name }), index.h("span", { class: "slider round" })), (this.hasLabel || this.hasOnOffLabel) && this.labelPosition === "right" && this.JSXLabel(this.hasOnOffLabel ? (this.checked ? this.on : this.off) : this.label)));
  }
};
...
const MwTab = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("button", { disabled: this.disabled, class: `mw-tab ${this.icon && this.label ? "label-with-icon" : ""} ${this.selected ? "selected" : ""}` }, this.icon && index.h("mw-icon", { icon: this.icon, size: "medium" }), this.label)));
  }
};
...
const MwTextfield = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "wrapper" }, index.h("div", { class: {
        ...
        "has-error": this.hasError,
      }, onFocus: this.onFocus, onBlur: this.onBlur, onInput: this.onValueChange, onChange: this.onValueChange, type: this.type, name: this.name, value: this.value, disabled: this.disabled, readOnly: this.readOnly }), index.h("span", { class: { "icon-end": this.hasIconEndSlot, "focused": this.focused, "has-error": this.hasError }, part: "icon-end" }, index.h("slot", { name: "icon-end" }))), this.helperText && this.layout === LayoutEnum.VERTICAL && index.h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError })), this.helperText && this.layout === LayoutEnum.HORIZONTAL && index.h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }))));
  }
  get hostElement() { return index.getElement(this); }
};
...
exports.mw_checkbox_group = MwCheckboxGroup;
