import { r as registerInstance, h, H as Host, g as getElement } from "./index-3359c25c.js";
...
const MwModal = class {
    ...
    render() {
        return h(Host, {
            ...
            class: "mw-modal__backdrop",
            part: "backdrop",
            backdropDismiss: this.backdropDismiss
        }), h("div", {
            class: `mw-modal__wrapper mw-modal__wrapper--${this.size}`,
            part: "content"
        }, h("slot", null))));
    }
    get el() {
