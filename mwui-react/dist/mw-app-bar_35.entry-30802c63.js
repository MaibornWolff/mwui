import { r as registerInstance, h, H as Host, c as createEvent, g as getElement } from './index-78bd0f61.js';
...
const mwAppBarTitleCss = ":host .mw-app-bar-title{color:var(--mw-component-app-bar-fg-default);font-family:var(--mw-component-app-bar-title-font-family);font-weight:var(--mw-component-app-bar-title-font-weight);line-height:var(--mw-component-app-bar-title-line-height);font-size:var(--mw-component-app-bar-title-font-size)}";
...
const MwAutocomplete = class {
  ...
  render() {
    return (h(Host, null, h("div", { tabindex: "0", class: "wrapper", role: AriaRolesEnum.COMBOBOX }, h("div", { class: {
      ...
      } }, h("mw-label", { name: this.name, label: this.label, required: this.required }), h("mw-popover", { noPadding: true, closeOnClick: true, open: this.isDropdownOpen, dismissable: this.isDropdownOpen, disabled: this.disabled }, this.multiple ? (h("mw-chip-input", { name: this.name, placeholder: this.placeholder, disabled: this.disabled, hasError: this.hasError, maximum: this.maximum, selectedChips: this.selection, onFocus: this.onFocus, onBlur: this.onBlur, onValueChanged: this.handleChipListValueChange, onInput: this.onInputChange, slot: "anchor" }, this.hasIconStartSlot && (h("div", { class: {
        "focused": this.focused,
        "has-error": this.hasError,
      }, slot: "icon-start" }, h("slot", { name: "icon-start" }))), h("mw-icon", { slot: "icon-end", icon: this.isDropdownOpen ? "keyboard_arrow_up" : "keyboard_arrow_down", size: "medium" }))) : (h("mw-textfield", { disabled: this.disabled, type: this.type, value: this.value, name: this.name, hasError: this.hasError, placeholder: this.placeholder, onChange: this.onInputChange, onInput: this.onInputChange, slot: "anchor" }, this.hasIconStartSlot && (h("div", { class: {
        "focused": this.focused,
        "has-error": this.hasError,
      }, slot: "icon-start" }, h("slot", { name: "icon-start" }))), h("span", { class: {
        "focused": this.focused,
        "has-error": this.hasError,
      }, slot: "icon-end" }, h("mw-icon", { icon: this.isDropdownOpen ? "keyboard_arrow_up" : "keyboard_arrow_down", size: "medium" })))), h("div", { slot: "content" }, this.canAddToValues() ? h("slot", { name: "dropdown-menu" }) : h("div", { class: "maximum-reached" }, this.maximumText), h("div", { ref: el => (this.noSuggestionsDisclaimer = el), class: "no-suggestions" }, this.noSuggestionsText)))), (this.helperText || (this.optionCounter && this.maximum)) && (h("div", { class: "helper-text-container" }, h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }), this.maximum && this.optionCounter && h("mw-helper-text", { helperText: `${this.selection.length}/${this.maximum}` }))))));
  }
...
const MwButton = class {
  ...
  render() {
    const button = (h("button", { part: "button", disabled: this.disabled, onClick: this.handleClick, title: this.label, class: {
        "mw-button": true,
    ...
    return (h(Host, null, this.href ? (h("a", { target: this.target, href: this.href }, button)) : (button)));
  }
  get hostElement() { return getElement(this); }
};
...
const MwCardImage = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: { "card-image": true, "top": this.isFirstChild, "bottom": this.isLastChild, "single": this.isOnlyChild } }, h("img", { src: this.src, alt: this.alt, style: this.styles }))));
  }
  get hostElement() { return getElement(this); }
};
...
const mwCheckboxCss = ".mw-checkbox-container{position:relative;display:inline-flex;align-items:center;gap:var(--mw-component-controls-with-label-gap);padding:var(--mw-component-controls-with-label-padding-y) var(--mw-component-controls-with-label-padding-r) var(--mw-component-controls-with-label-padding-y) var(--mw-component-controls-with-label-padding-l);}.mw-checkbox-container.enabled{cursor:pointer}.mw-checkbox-container.enabled .mw-checkbox-label{cursor:pointer}.mw-checkbox-container.left{justify-content:end}.mw-checkbox-container input{position:absolute;opacity:0;height:0;width:0;cursor:pointer}.mw-checkbox-container .mw-checkbox-outer{width:var(--mw-component-size-controls-checkbox-radio-container);height:var(--mw-component-size-controls-checkbox-radio-container);display:flex;justify-content:center;align-items:center}.mw-checkbox-container .mw-checkbox{box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;width:var(--mw-component-size-controls-checkbox-box);height:var(--mw-component-size-controls-checkbox-box);border-radius:var(--mw-component-checkbox-border-radius);display:flex;justify-content:center;align-items:center}.mw-checkbox-container .mw-checkbox.unselected.enabled{border:var(--mw-component-controls-border-width-unselected) solid var(--mw-component-controls-color-outline-default);background:var(--mw-component-controls-color-bg-unselected)}.mw-checkbox-container .mw-checkbox.unselected.disabled{background:var(--mw-component-controls-color-bg-unselected);border:var(--mw-component-controls-border-width-unselected) solid var(--mw-component-controls-color-outline-disabled)}.mw-checkbox-container .mw-checkbox.selected.enabled{background:var(--mw-component-controls-color-bg-selected);border:var(--mw-component-controls-border-width-selected) solid var(--mw-component-controls-color-outline-default)}.mw-checkbox-container .mw-checkbox.selected.disabled{background:var(--mw-component-controls-color-bg-disabled);border:var(--mw-component-controls-border-width-selected) solid var(--mw-component-controls-color-outline-disabled)}.mw-checkbox-container:hover{}.mw-checkbox-container:hover .mw-checkbox.unselected.enabled{background:var(--mw-component-controls-color-bg-hover);border:var(--mw-component-controls-border-width-unselected) solid var(--mw-component-controls-color-outline-default)}.mw-checkbox-container:hover .mw-checkbox.selected.enabled{background:var(--mw-component-controls-color-bg-hover);border:var(--mw-component-controls-border-width-selected) solid var(--mw-component-controls-color-outline-default)}.mw-checkbox-container:active{}.mw-checkbox-container:active .mw-checkbox.unselected.enabled{background:var(--mw-component-controls-color-bg-pressed);border:var(--mw-component-controls-border-width-unselected) solid var(--mw-component-controls-color-outline-default)}.mw-checkbox-container:active .mw-checkbox.selected.enabled{background:var(--mw-component-controls-color-bg-pressed);border:var(--mw-component-controls-border-width-selected) solid var(--mw-component-controls-color-outline-default)}.mw-checkbox-container input:focus+.mw-checkbox.unselected.enabled{background:var(--mw-component-controls-color-bg-focused);border:var(--mw-component-controls-border-width-focused) solid var(--mw-component-controls-color-outline-default)}.mw-checkbox-container input:focus+.mw-checkbox.selected.enabled{background:var(--mw-component-controls-color-bg-focused);border:var(--mw-component-controls-border-width-focused) solid var(--mw-component-controls-color-outline-default)}.mw-checkbox-container .mw-checkmark{display:none}.mw-checkbox-container .mw-checkmark.selected{display:unset}.mw-checkbox-container .mw-checkbox-label{font-family:var(--mw-component-control-label-font-family);font-weight:var(--mw-component-control-label-font-weight);font-size:var(--mw-component-control-label-font-size);line-height:var(--mw-component-control-label-line-height);color:var(--mw-component-controls-color-label-default)}.mw-checkbox-container .mw-checkbox-label.disabled{color:var(--mw-component-controls-color-label-disabled)}";
...
const MwCheckbox = class {
  constructor(hostRef) {
    ...
    this.JSXLabel = (h("label", { class: `mw-checkbox-label ${this.disabled ? "disabled" : "enabled"}`, htmlFor: this.checkboxId }, this.label));
    this.testId = undefined;
    this.value = undefined;
    this.name = undefined;
    this.checked = false;
    ...
    this.disabled = false;
    this.label = undefined;
    this.labelPosition = PositionEnum.RIGHT;
  }
  componentWillLoad() {
    if (this.indeterminate)
      this.checked = false;
  ...
  render() {
    return (h(Host, { "test-id": this.testId, class: `mw-checkbox-container ${this.disabled ? "disabled" : "enabled"} ${this.labelPosition}`, onClick: this.handleCheck, "aria-checked": `${this.checked}`, "aria-hidden": this.disabled ? "true" : null, role: "checkbox" }, this.label && this.labelPosition === "left" && this.JSXLabel, h("input", { id: this.checkboxId, type: "checkbox", checked: this.checked, value: this.value, name: this.name }), h("span", { class: "mw-checkbox-outer" }, h("span", { class: `mw-checkbox ${this.checked || this.indeterminate ? "selected" : "unselected"} ${this.disabled ? "disabled" : "enabled"}` }, h("mw-icon", { class: `mw-checkmark ${this.checked || this.indeterminate ? "selected" : "unselected"}`, color: `var(--mw-component-controls-color-fg-default)`, icon: this.indeterminate ? "check_indeterminate_small" : "check", size: "small" }))), this.label && this.labelPosition === "right" && this.JSXLabel));
  }
...
(function (LayoutDirectionEnum) {
  LayoutDirectionEnum["ROW"] = "row";
  LayoutDirectionEnum["COLUMN"] = "column";
  LayoutDirectionEnum["ROW_REVERSE"] = "row-reverse";
  LayoutDirectionEnum["COLUMN_REVERSE"] = "column-reverse";
})(LayoutDirectionEnum || (LayoutDirectionEnum = {}));

const mwCheckboxGroupCss = ".mw-checkbox-group{display:flex;padding-left:var(--mw-component-controls-margin-margin-left)}.mw-checkbox-group.row{flex-direction:row}.mw-checkbox-group.column{flex-direction:column}.mw-checkbox-group.row-reverse{flex-direction:row-reverse}.mw-checkbox-group.column-reverse{flex-direction:column-reverse}.mw-checkbox-group.wrap{flex-wrap:wrap}";

const MwCheckboxGroup = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.checkboxChange = createEvent(this, "checkboxChange", 4);
    this.onClick = (value, disabled) => {
      if (!disabled) {
    ...
    this.direction = LayoutDirectionEnum.COLUMN;
    this.wrap = false;
    this.checkboxes = [];
  ...
  render() {
    return (h(Host, { role: "checkboxgroup" }, h("mw-checkbox", { label: this.parentLabel, checked: this.checked, indeterminate: this.indeterminate, onClick: this.onParentClick }), h("div", { class: `mw-checkbox-group ${this.direction} ${this.wrap ? "wrap" : ""}` }, this.checkboxes.map((item, key) => (h("mw-checkbox", { key: key, label: item.label, disabled: item.disabled, checked: this.value.includes(item.value), value: item.value, onClick: () => this.onClick(item.value, item.disabled) }))))));
  }
...
const MwChipInput = class {
  ...
  render() {
    var _a;
    const { onFocus, disabled, hasIconStartSlot, hasIconEndSlot, focused, placeholder, onBlur, name, clearMultiValues, selected, required, hasError, layout, helperText, optionCounter, maximum, } = this;
    return (h(Host, null, h("div", { class: "wrapper" }, h("div", { class: {
      ...
      selected.map(v => (h("mw-chip", { key: v, onMwChipClose: () => this.onRemoveSelection(v), showClose: true, value: v, selected: true, toggleable: false, disabled: disabled }, v))), this.canAddToValues() && (h("input", { ref: el => (this.inputElement = el), class: {
        "has-error": this.hasError,
        "mw-chip-input": true,
      }, placeholder: ((_a = this.selected) === null || _a === void 0 ? void 0 : _a.length) === 0 ? placeholder : null, onFocus: onFocus, onBlur: onBlur, type: "text", name: name, value: this.value, disabled: disabled, onInput: this.handleInputChange, onChange: this.onValueChange }))), this._selection.hasValues() && (h("span", { class: "icon-close-multiple", onClick: clearMultiValues }, h("mw-icon", { icon: "close", size: "medium" }))), h("div", { class: {
        "icon-end": hasIconEndSlot,
        "focused": focused,
        "has-error": hasError,
      } }, h("slot", { name: "icon-end" })))), (helperText || (optionCounter && maximum)) && (h("div", { class: "helper-text-container" }, h("mw-helper-text", { helperText: helperText, hasError: hasError }), maximum && optionCounter && h("mw-helper-text", { helperText: `${this.selected.length}/${maximum}` }))))));
  }
  get hostElement() { return getElement(this); }
  static get watchers() { return {
...
const mwDropdownCss = ":host{display:flex;align-items:center}.wrapper{width:100%;display:flex;flex-direction:column;gap:var(--mw-component-text-field-gap-group-vertical)}.dropdown{display:flex;flex-direction:column;min-width:var(--mw-component-size-text-field-min-width);color:var(--mw-component-text-field-fg-default);gap:var(--mw-component-text-field-gap-group-vertical)}.dropdown.disabled,.dropdown.disabled input{color:var(--mw-component-text-field-fg-disabled)}.dropdown.horizontal{flex-direction:row;display:flex;align-items:center;gap:0}.dropdown.horizontal .input{min-width:var(--mw-component-size-text-field-min-w);width:100%}.dropdown.horizontal label{display:block;width:var(--mw-component-size-text-field-label-horizontal-width);padding:var(--mw-component-text-field-padding-label-horizontal)}.dropdown.horizontal .input{width:auto}.input{display:flex;align-items:center;border-radius:var(--border-radius-standard-md);padding:var(--mw-component-text-field-padding-text-field-y) var(--mw-component-text-field-padding-text-field-x);background:var(--mw-component-text-field-bg-default);box-shadow:inset 0 0 0 var(--mw-component-text-field-default) var(--mw-component-text-field-border-default)}.input .icon-start{margin-right:var(--mw-component-text-field-gap-horizontal-gap-within)}.input .icon-end{margin-left:var(--mw-component-text-field-gap-horizontal-gap-within)}.input.has-error{background:var(--mw-component-text-field-bg-error);color:var(--mw-component-text-field-fg-error)}.input:focus-within{background:var(--mw-component-text-field-bg-hover);box-shadow:inset 0 0 0 var(--mw-component-text-field-focused) var(--mw-component-text-field-border-focused)}.input:not(.disabled):hover{background:var(--mw-component-text-field-bg-hover)}.input .icon{color:var(--mw-component-text-field-fg-icon-default)}.input .focused{color:var(--mw-component-text-field-fg-icon-focused)}.input input{border:none;padding:0;width:100%;background:transparent;font-family:var(--mw-component-text-field-text-font-family);font-weight:var(--mw-component-text-field-text-font-weight);font-size:var(--mw-component-text-field-text-font-size);line-height:var(--mw-component-text-field-text-line-height)}.input input:focus-visible,.input input:focus{outline:transparent;border:none;box-shadow:none}.input input::placeholder{color:var(--mw-component-text-field-fg-placeholder)}.input button{cursor:pointer;border:none;padding:0;width:100%;background:transparent;text-align:left;font-family:var(--mw-component-text-field-text-font-family);font-weight:var(--mw-component-text-field-text-font-weight);font-size:var(--mw-component-text-field-text-font-size);line-height:var(--mw-component-text-field-text-line-height)}.input button:focus-visible,.input button:focus{outline:none;border:none;box-shadow:none}.input button.placeholder{color:var(--mw-component-text-field-fg-placeholder)}";
...
const MwDropdown = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: "wrapper" }, h("div", { class: { "dropdown": true, "horizontal": this.layout === LayoutEnum.HORIZONTAL, "has-error": this.hasError, "disabled": this.disabled } }, h("mw-label", { name: this.name, label: this.label, required: this.required }), h("mw-popover", { noPadding: true, closeOnClick: true, open: this.isDropdownOpen }, h("div", { slot: "anchor", onClick: this.onFocus, class: { "input": true, "has-error": this.hasError, "disabled": this.disabled } }, h("span", { class: {
        ...
        "focused": this.focused,
        "has-error": this.hasError,
      } }, h("mw-icon", { icon: this.isDropdownOpen ? "keyboard_arrow_up" : "keyboard_arrow_down", size: "medium" })))), h("div", { slot: "content" }, h("slot", { name: "dropdown-menu" }))), this.helperText && this.layout === LayoutEnum.VERTICAL && h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError })), this.helperText && this.layout === LayoutEnum.HORIZONTAL && h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }))));
  }
  get host() { return getElement(this); }
};
...
const mwIconCss = "@import url(\"https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200\");.material-symbols-outlined{font-family:\"Material Symbols Outlined\";display:flex;justify-content:center;align-items:center}.material-symbols-outlined.x-small{width:var(--mw-component-size-avatars-icon-xs);height:var(--mw-component-size-avatars-icon-xs)}.material-symbols-outlined.small{width:var(--mw-component-size-avatars-icon-sm);height:var(--mw-component-size-avatars-icon-sm)}.material-symbols-outlined.medium{width:var(--mw-component-size-avatars-icon-md);height:var(--mw-component-size-avatars-icon-md)}.material-symbols-outlined.large{width:var(--mw-component-size-avatars-icon-lg);height:var(--mw-component-size-avatars-icon-lg)}.material-symbols-outlined.x-large{width:var(--mw-component-size-avatars-icon-xl);height:var(--mw-component-size-avatars-icon-xl)}";
...
const mwPopoverCss = ":host{display:block;width:100%}.mw-popover{position:relative}.mw-popover-content{min-width:180px;width:100%;box-sizing:border-box;margin:12px;visibility:hidden;position:absolute;box-shadow:0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12);padding:12px;background:var(--mw-component-menu-item-bg-default);border-radius:var(--mw-component-menu-item-border-radius);border-width:var(--mw-component-menu-item-border-width-default)}.mw-popover-content.no-padding{padding:0;margin:0}.mw-popover-content.open{visibility:visible;position:relative;z-index:999}";
...
const mwRadioCss = ".mw-radio-container{position:relative;display:inline-flex;align-items:center;gap:var(--mw-component-controls-with-label-gap);padding:var(--mw-component-controls-with-label-padding-y) var(--mw-component-controls-with-label-padding-r) var(--mw-component-controls-with-label-padding-y) var(--mw-component-controls-with-label-padding-l);}.mw-radio-container.enabled{cursor:pointer}.mw-radio-container.enabled .mw-radio-label{cursor:pointer}.mw-radio-container.left{justify-content:end}.mw-radio-container:hover{}.mw-radio-container:hover input~.mw-radio-outer>.mw-radio{background-color:var(--mw-component-controls-color-bg-hover)}.mw-radio-container:hover input:checked~.mw-radio-outer>.mw-radio{background-color:var(--mw-component-controls-color-bg-hover)}.mw-radio-container:active{}.mw-radio-container:active input~.mw-radio-outer>.mw-radio{background-color:var(--mw-component-controls-color-bg-pressed)}.mw-radio-container:active input:checked~.mw-radio-outer>.mw-radio{background-color:var(--mw-component-controls-color-bg-pressed)}.mw-radio-container .mw-radio-label.disabled{color:var(--mw-component-controls-color-label-disabled)}.mw-radio-container input{position:absolute;opacity:0;height:0;width:0;margin:0;cursor:pointer;}.mw-radio-container input:checked~.mw-radio-outer>.mw-radio{border-width:var(--mw-component-controls-border-width-selected);background-color:var(--mw-component-controls-color-bg-selected)}.mw-radio-container input:checked~.mw-radio-outer>.mw-radio:after{content:\"\";border-radius:var(--border-radius-standard-circle);height:var(--mw-component-size-controls-radio-fill);width:var(--mw-component-size-controls-radio-fill);background-color:var(--mw-component-controls-color-fg-default)}.mw-radio-container input:disabled:checked~.mw-radio-outer>.mw-radio{background-color:var(--mw-component-controls-color-bg-disabled);border-width:var(--mw-component-controls-border-width-selected)}.mw-radio-container input:disabled:checked~.mw-radio-outer>.mw-radio:after{background-color:var(--mw-component-controls-color-fg-disabled)}.mw-radio-container input:focus~.mw-radio-outer>.mw-radio{border:var(--mw-component-controls-border-width-focused) solid var(--mw-component-controls-color-outline-default)}.mw-radio-container input:focus:checked~.mw-radio-outer>.mw-radio{background-color:var(--mw-component-controls-color-bg-focused)}.mw-radio-container input:disabled~.mw-radio-outer>.mw-radio{border:var(--mw-component-controls-border-width-unselected) solid var(--mw-component-controls-color-outline-disabled);background-color:var(--mw-component-controls-color-bg-unselected)}.mw-radio-container .mw-radio-label{color:var(--mw-component-controls-color-label-default);font-size:var(--mw-semantic-font-font-size-body-regular);line-height:var(--mw-semantic-font-line-height-body-regular);font-family:var(--mw-core-font-font-families-body);font-weight:var(--mw-core-font-weight-body-regular)}.mw-radio-container .mw-radio-outer{width:var(--mw-component-size-controls-checkbox-radio-container);height:var(--mw-component-size-controls-checkbox-radio-container);display:flex;justify-content:center;align-items:center}.mw-radio-container .mw-radio{box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;display:flex;justify-content:center;align-items:center;height:var(--mw-component-size-controls-radio-outline);width:var(--mw-component-size-controls-radio-outline);border:var(--mw-component-controls-border-width-unselected) solid var(--mw-component-controls-color-outline-default);border-radius:var(--border-radius-standard-circle)}";
...
const MwRadio = class {
  constructor(hostRef) {
    ...
    this.JSXLabel = (h("label", { class: `mw-radio-label ${this.disabled ? "disabled" : "enabled"}`, htmlFor: this.radioId }, this.label));
    this.disabled = undefined;
    this.checked = false;
    this.value = undefined;
    this.name = undefined;
  ...
  render() {
    return (h(Host, { "test-id": this.testId, onClick: this.onClick, class: `mw-radio-container ${this.disabled ? "disabled" : "enabled"} ${this.labelPosition}`, "aria-checked": `${this.checked}`, "aria-hidden": this.disabled ? "true" : null, role: "radio" }, this.label && this.labelPosition === "left" && this.JSXLabel, h("input", { id: this.radioId, type: "radio", value: this.value, name: this.name, checked: this.checked, disabled: this.disabled }), h("span", { class: "mw-radio-outer" }, h("span", { class: "mw-radio" })), this.label && this.labelPosition === "right" && this.JSXLabel));
  }
  get hostElement() { return getElement(this); }
};
MwRadio.style = mwRadioCss;

const mwRadioGroupCss = ".mw-radio-group{display:flex}.mw-radio-group.row{flex-direction:row}.mw-radio-group.column{flex-direction:column}.mw-radio-group.row-reverse{flex-direction:row-reverse}.mw-radio-group.column-reverse{flex-direction:column-reverse}.mw-radio-group.wrap{flex-wrap:wrap}";

const MwRadioGroup = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.radioChange = createEvent(this, "radioChange", 6);
    this.onClick = (event) => {
      event.preventDefault();
  ...
  render() {
    return h(Host, { class: `mw-radio-group ${this.direction} ${this.wrap ? "wrap" : ""}`, role: "radiogroup", onClick: this.onClick });
  }
  get host() { return getElement(this); }
  static get watchers() { return {
    "value": ["valueChanged"]
...
const mwSwitchCss = ".mw-switch-container{display:inline-flex;align-items:center;gap:var(--mw-component-controls-with-label-gap);padding:var(--mw-component-controls-with-label-padding-y) var(--mw-component-controls-with-label-padding-r) var(--mw-component-controls-with-label-padding-y) var(--mw-component-controls-with-label-padding-l);}.mw-switch-container.enabled{cursor:pointer}.mw-switch-container.enabled .mw-switch-label{cursor:pointer}.mw-switch-container.left{justify-content:end}.mw-switch-container .mw-switch-label{font-size:var(--mw-component-control-label-font-size);font-family:var(--mw-component-control-label-font-family);color:var(--mw-component-controls-color-label-default)}.mw-switch-container .mw-switch-label.disabled{color:var(--mw-component-controls-color-label-disabled)}.mw-switch-container .switch{position:relative;display:inline-block;width:var(--mw-component-size-switch-default-w);height:var(--mw-component-size-switch-default-h)}.mw-switch-container .switch input{opacity:0;width:0;height:0;margin:0;cursor:pointer}.mw-switch-container .slider{position:absolute;top:0;left:0;right:0;bottom:0;background-color:var(--mw-component-controls-color-bg-unselected);-webkit-transition:0.4s;transition:0.4s}.mw-switch-container input:checked+.slider:before{position:absolute;content:\"\";height:20px;width:20px;left:6px;bottom:4px;background-color:var(--mw-component-controls-color-fg-default);-webkit-transition:0.4s;transition:0.4s;-webkit-transform:translateX(20px);-ms-transform:translateX(20px);transform:translateX(20px)}.mw-switch-container input:not(:checked)+.slider:before{position:absolute;content:\"\";height:16px;width:16px;left:6px;bottom:6px;background-color:var(--mw-component-controls-color-fg-off);-webkit-transition:0.4s;transition:0.4s}.mw-switch-container:hover{}.mw-switch-container:hover input:not(:disabled)+.slider{background-color:var(--mw-component-controls-color-bg-hover)}.mw-switch-container:active{}.mw-switch-container:active input:not(:disabled)+.slider:before{position:absolute;content:\"\";height:24px;width:24px;left:5px;bottom:2px;background-color:var(--mw-component-controls-color-fg-default);-webkit-transition:0.4s;transition:0.4s}.mw-switch-container:active input:not(:checked):not(:disabled)+.slider:before{position:absolute;content:\"\";height:24px;width:24px;left:2px;bottom:2px;background-color:var(--mw-component-controls-color-fg-off);-webkit-transition:0.4s;transition:0.4s}.mw-switch-container input:not(:disabled):active+.slider:before{position:absolute;content:\"\";height:24px;width:24px;left:5px;bottom:2px;background-color:var(--mw-component-controls-color-fg-default);-webkit-transition:0.4s;transition:0.4s}.mw-switch-container input:not(:checked):not(:disabled):active+.slider:before{position:absolute;content:\"\";height:24px;width:24px;left:2px;bottom:2px;background-color:var(--mw-component-controls-color-fg-off);-webkit-transition:0.4s;transition:0.4s}.mw-switch-container input:disabled+.slider:before{background-color:var(--mw-component-controls-color-fg-disabled)}.mw-switch-container input:checked+.slider{background-color:var(--mw-component-controls-color-bg-selected)}.mw-switch-container input:disabled+.slider{background-color:var(--mw-component-controls-color-bg-disabled)}.mw-switch-container input:focus:not(:active):not(:disabled)+.slider{box-shadow:inset 0 0 0 var(--mw-component-controls-border-width-focused) var(--mw-component-controls-color-outline-default);background-color:var(--mw-component-controls-color-bg-focused)}.mw-switch-container input:active:not(:disabled)+.slider{background-color:var(--mw-component-controls-color-bg-pressed)}.mw-switch-container input:not(:checked):not(:disabled)+.slider{box-shadow:inset 0 0 0 var(--mw-component-controls-border-width-unselected) var(--mw-component-controls-color-outline-default)}.mw-switch-container input:not(:checked):disabled+.slider{box-shadow:inset 0 0 0 var(--mw-component-controls-border-width-unselected) var(--mw-component-controls-color-outline-disabled)}.mw-switch-container .slider.round{border-radius:34px;-webkit-border-radius:34px}.mw-switch-container .slider.round:before{border-radius:50%;-webkit-border-radius:50%}";

const MwSwitch = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.emitter = createEvent(this, "emitter", 7);
    this.switchId = v4();
    ...
    this.JSXLabel = (label) => {
      return (h("label", { htmlFor: this.switchId }, h("span", { class: `mw-switch-label ${this.disabled ? "disabled" : "enabled"}` }, label)));
    };
    this.testId = undefined;
    this.disabled = undefined;
    this.label = undefined;
...
const MwTab = class {
  ...
  render() {
    return (h(Host, null, h("button", { disabled: this.disabled, class: `mw-tab ${this.icon && this.label ? "label-with-icon" : ""} ${this.selected ? "selected" : ""}` }, this.icon && h("mw-icon", { icon: this.icon, size: "medium" }), this.label)));
  }
};
...
const MwTextarea = class {
  constructor(hostRef) {
    ...
    this.blurEmitter = createEvent(this, "blurEmitter", 7);
    this.onChange = (event) => {
      this.value = event.target.value;
  ...
  render() {
    return (h(Host, null, h("div", { class: "wrapper" }, h("div", { class: {
        ...
        "has-error": this.hasError,
        "disabled": this.disabled,
      } }, h("mw-label", { name: this.name, label: this.label, required: this.required }), h("textarea", { placeholder: this.placeholder, style: { resize: this.resize }, class: {
        "textarea": true,
        "has-error": this.hasError,
      }, onInput: this.onInput, onChange: this.onChange, onBlur: this.onBlur, name: this.name, value: this.value, disabled: this.disabled, readonly: this.readonly, maxlength: this.maxlength, cols: this.cols, rows: this.rows, form: this.form, required: this.required })), h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }))));
  }
  get hostElement() { return getElement(this); }
};
MwTextarea.style = mwTextareaCss;

const mwTextfieldCss = ":host{display:flex;align-items:center}.wrapper{display:inline-flex;flex-direction:column;width:100%;gap:var(--mw-component-text-field-gap-group-vertical)}.textfield{display:flex;flex-direction:column;min-width:var(--mw-component-size-text-field-min-width);color:var(--mw-component-text-field-fg-default);gap:var(--mw-component-text-field-gap-group-vertical)}.textfield.disabled,.textfield.disabled input{color:var(--mw-component-text-field-fg-disabled)}.textfield.horizontal{flex-direction:row;display:flex;align-items:center;gap:0}.textfield.horizontal .input{min-width:var(--mw-component-size-text-field-min-w);width:100%}.textfield.horizontal label{display:block;width:var(--mw-component-size-text-field-label-horizontal-width);padding:var(--mw-component-text-field-padding-label-horizontal)}.input{display:flex;align-items:center;border-radius:var(--border-radius-standard-md);padding:var(--mw-component-text-field-padding-text-field-y) var(--mw-component-text-field-padding-text-field-x);background:var(--mw-component-text-field-bg-default);box-shadow:inset 0 0 0 var(--mw-component-text-field-default) var(--mw-component-text-field-border-default)}.input .icon-start{margin-right:var(--mw-component-text-field-gap-horizontal-gap-within)}.input .icon-end{margin-left:var(--mw-component-text-field-gap-horizontal-gap-within)}.input.has-error{background:var(--mw-component-text-field-bg-error);color:var(--mw-component-text-field-fg-error)}.input:focus-within{background:var(--mw-component-text-field-bg-hover);box-shadow:inset 0 0 0 var(--mw-component-text-field-focused) var(--mw-component-text-field-border-focused)}.input:not(.disabled):hover{background:var(--mw-component-text-field-bg-hover)}.input .icon{color:var(--mw-component-text-field-fg-icon-default)}.input .focused{color:var(--mw-component-text-field-fg-icon-focused)}.input input{border:none;padding:0;width:100%;background:transparent;font-family:var(--mw-component-text-field-text-font-family);font-weight:var(--mw-component-text-field-text-font-weight);font-size:var(--mw-component-text-field-text-font-size);line-height:var(--mw-component-text-field-text-line-height)}.input input:focus-visible,.input input:focus{outline:transparent;border:none;box-shadow:none}.input input::placeholder{color:var(--mw-component-text-field-fg-placeholder)}";
...
const MwTextfield = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: "wrapper" }, h("div", { class: {
        ...
        "has-error": this.hasError,
      }, onFocus: this.onFocus, onBlur: this.onBlur, onInput: this.onValueChange, onChange: this.onValueChange, type: this.type, name: this.name, value: this.value, disabled: this.disabled, readOnly: this.readOnly }), h("span", { class: { "icon-end": this.hasIconEndSlot, "focused": this.focused, "has-error": this.hasError }, part: "icon-end" }, h("slot", { name: "icon-end" }))), this.helperText && this.layout === LayoutEnum.VERTICAL && h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError })), this.helperText && this.layout === LayoutEnum.HORIZONTAL && h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }))));
  }
  get hostElement() { return getElement(this); }
};
MwTextfield.style = mwTextfieldCss;

export { MwAppBar as mw_app_bar, MwAppBarTitle as mw_app_bar_title, MwAutocomplete as mw_autocomplete, MwAvatar as mw_avatar, MwButton as mw_button, MwCard as mw_card, MwCardBody as mw_card_body, MwCardFooter as mw_card_footer, MwCardHeader as mw_card_header, MwCardImage as mw_card_image, MwCardTitle as mw_card_title, MwCheckbox as mw_checkbox, MwCheckboxGroup as mw_checkbox_group, MwChip as mw_chip, MwChipInput as mw_chip_input, MwDivider as mw_divider, MwDropdown as mw_dropdown, MwHelperText as mw_helper_text, MwIcon as mw_icon, MwIconGallery as mw_icon_gallery, MwLabel as mw_label, MwLink as mw_link, MwLogin as mw_login, MwMenu as mw_menu, MwMenuItem as mw_menu_item, MwMenuList as mw_menu_list, MwPopover as mw_popover, MwRadio as mw_radio, MwRadioGroup as mw_radio_group, MwSlider as mw_slider, MwSwitch as mw_switch, MwTab as mw_tab, MwTabs as mw_tabs, MwTextarea as mw_textarea, MwTextfield as mw_textfield };
