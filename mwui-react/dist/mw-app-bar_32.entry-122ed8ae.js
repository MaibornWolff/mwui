...
const MwAutocomplete = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { tabindex: "0", class: "wrapper", role: AriaRolesEnum.COMBOBOX }, index.h("div", { class: {
      ...
      } }, index.h("mw-label", { name: this.name, label: this.label, required: this.required }), index.h("mw-popover", { noPadding: true, closeOnClick: true, open: this.isDropdownOpen, dismissable: this.isDropdownOpen, disabled: this.disabled }, this.multiple ? (index.h("mw-chip-input", { name: this.name, placeholder: this.placeholder, disabled: this.disabled, hasError: this.hasError, maximum: this.maximum, selectedChips: this.selected, onFocus: this.onFocus, onBlur: this.onBlur, onMwChipListValueChanged: this.handleChipListValueChange.bind(this), onMwChipListInputChange: this.onInputChange.bind(this), slot: "anchor" }, this.hasIconStartSlot && (index.h("div", { class: {
        "focused": this.focused,
        "has-error": this.hasError,
      }, slot: "icon-start" }, index.h("slot", { name: "icon-start" }))), index.h("mw-icon", { slot: "icon-end", icon: this.isDropdownOpen ? "keyboard_arrow_up" : "keyboard_arrow_down", size: "medium" }))) : (index.h("mw-textfield", { disabled: this.disabled, type: this.type, value: this.value, name: this.name, hasError: this.hasError, placeholder: this.placeholder, onMwTextfieldValueChanged: this.onInputChange.bind(this), slot: "anchor" }, this.hasIconStartSlot && (index.h("div", { class: {
        "focused": this.focused,
        "has-error": this.hasError,
      }, slot: "icon-start" }, index.h("slot", { name: "icon-start" }))), index.h("span", { class: {
        "focused": this.focused,
        "has-error": this.hasError,
      }, slot: "icon-end" }, index.h("mw-icon", { icon: this.isDropdownOpen ? "keyboard_arrow_up" : "keyboard_arrow_down", size: "medium" })))), index.h("div", { slot: "content" }, this.canAddToValues() ? index.h("slot", { name: "dropdown-menu" }) : index.h("div", { class: "maximum-reached" }, this.maximumText), index.h("div", { ref: el => (this.noSuggestionsDisclaimer = el), class: "no-suggestions" }, this.noSuggestionsText)))), index.h("div", { class: "helper-text-container" }, index.h("mw-helper-text", { helperText: this.helperText, hasError: this.hasError }), this.maximum && this.optionCounter && index.h("mw-helper-text", { helperText: `${this.selected.length}/${this.maximum}` })))));
  }
...
const MwButton = class {
  ...
  render() {
    const button = (index.h("button", { part: "button", disabled: this.disabled, onClick: this.handleClick, title: this.title, class: {
        "mw-button": true,
...
const MwCardImage = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: { "card-image": true, "top": this.isFirstChild, "bottom": this.isLastChild, "single": this.isOnlyChild } }, index.h("img", { src: this.src, alt: this.alt }))));
  }
  get hostElement() { return index.getElement(this); }
};
...
const MwChipInput = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "wrapper" }, index.h("div", { class: {
      ...
      selected.map(v => (index.h("mw-chip", { key: v, showClose: true, value: v, selected: true, toggleable: false, disabled: disabled }, v))), this.canAddToValues() && (index.h("input", { ref: el => (this.inputElement = el), class: {
        "has-error": this.hasError,
      }, placeholder: ((_a = this.selected) === null || _a === void 0 ? void 0 : _a.length) === 0 ? placeholder : null, onFocus: onFocus, onBlur: onBlur, type: "text", name: name, value: this.value, disabled: disabled, onInput: handleInputChange.bind(this) }))), this._selection.hasValues() && (index.h("span", { class: "icon-close-multiple", onClick: clearMultiValues }, index.h("mw-icon", { icon: "close", size: "medium" }))), index.h("div", { class: {
...
const MwSwitch = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("label", { "test-id": this.testId, onClick: this.toggleSwitch.bind(this), class: "switch" }, index.h("input", { disabled: this.disabled, ref: (el) => (this.checkbox = el), type: "checkbox", checked: this.checked }), index.h("span", { class: "slider round" })), this.hasLabel && index.h("span", { class: "label" }, this.label), this.hasOnOffLabel && index.h("span", { class: "label" }, this.checked ? this.on : this.off)));
  }
};
