                    ...
                    switch (_d.label) {
                        case 0:
                            (_a = this.props),
                                ...
                                (onDidPresent = _a.onDidPresent),
                                (onWillDismiss = _a.onWillDismiss),
                                (onWillPresent = _a.onWillPresent),
                                (cProps = __rest(_a, ["children", "isOpen", "onDidDismiss", "onDidPresent", "onWillDismiss", "onWillPresent"]));
                            elementProps = __assign(
                                __assign({}, cProps),
                                ((_c = { ref: this.props.forwardedRef }),
                                (_c[didDismissEventName] = this.handleDismiss),
                                (_c[didPresentEventName] = function (e) {
