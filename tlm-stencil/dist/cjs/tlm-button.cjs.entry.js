 ...
 * Generated on Wed, 21 Dec 2022 07:37:18 GMT
 */
...
const base = css `
  ...
  font-weight: ${utils.getFontWeightValue(mwComponentButtonTypo.fontWeight)};
...
const TlmButton = class {
  ...
  render() {
    return (index.h("button", { disabled: this.disabled, onClick: this.handleClick, class: this.secondary ? secondaryButtonStyles : primaryButtonStyles, "test-id": this.testId, type: "button" }, this.hasIconStartSlot && (index.h("span", { class: iconStartStyles }, index.h("slot", { name: "icon-start" }))), index.h("slot", null), this.hasIconEndSlot && (index.h("span", { class: iconEndStyles }, index.h("slot", { name: "icon-end" })))));
  }
