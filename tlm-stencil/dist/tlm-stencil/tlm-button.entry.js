import { r as registerInstance, e as createEvent, h as h$1 } from './index-c590985d.js';
...
const whiteLabelMdPurple400 = "#6b60cd";
...
const semanticColorActionsFilledHoverBgColor = "#6b60cd";
...
const labelLabelFilledHoverBgColor = "#6b60cd";
...
const TlmButton = class {
  ...
  render() {
    return (h$1("button", { disabled: this.disabled, onClick: this.handleClick, class: buttonStyles, "test-id": this.testId, type: "button" }, h$1("slot", null)));
  }
};
