...
| `multipleMaximumText` | `multiple-maximum-text` | Text which is displayed when maximum amount of options is reached                                                              | `string`           | `"You reached the maximum number of options."` |
| `name`                | `name`                  | input field name                                                                                                               | `string`           | `undefined`                                    |
| `noMatchText`         | `no-match-text`         | Text which is displayed when no dropdown options match the user input                                                          | `string`           | `"No suggestions found."`                      |
