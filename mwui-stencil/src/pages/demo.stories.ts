...
<div style="font-family: Poppins">
      ...
      <section>
        <div style="width: 548px; margin: 0 auto; margin-top: 80px">
          ...
          <p>
            Schnell und efﬁzient in den Markt eintreten und weitere
            Produktlinien einführen – vor diesen Aufgaben stehen Unternehmen.
            Eine Herausforderung, denn Design- und Entwicklungsressourcen sind
            knapp. So helfen unsere smarten Design Systeme.
          </p>
        </div>
        <div
          style="
          ...
          >
            ...
            >
              ...
              <p>
                ...
                beschäftigen. Eine smarte Bibliothek an UI-Komponenten schafft
                ihnen diesen. So haben sie Zeit, herauszuarbeiten, was wirklich
                wichtig ist: Was wollen Ihre Nutzer*innen?
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              <h3 style="margin-top: 0px">
                Implementierungsaufwände reduzieren
              </h3>
              <p>
        ...
        <div style="width: 548px; margin: 0 auto; margin-top: 80px">
          ...
          <p style="font-weight: 700">Zeit- und Kostenersparnis</p>
          <p>
            Nutzen Sie Frameworks für das UI Design. Sie erhalten mehr Freiraum
            für essenzielle Aufgaben in der Produktentwicklung und Ihre Systeme
            skalieren schneller. Ein integratives Design System bewahrt Ihr Team
            vor Stress und schafft positive Nutzererfahrungen. Zudem erleichtert
            es die Kommunikation zwischen Design und Entwicklung.
          </p>
          <p style="font-weight: 700">Einheitlicher Auftritt</p>
          <p>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <h3 style="margin-top: 0px">
                Einsparung eröffnet neue Potentiale
              </h3>
              <p>Mehr Zeit für User-Research & Test = Innovationsbooster</p>
            </div>
          </div>
        </div>
      </section>
      <section>
        <div style="width: 548px; margin: 0 auto; margin-top: 80px">
          ...
          <p style="font-weight: 700">Definition</p>
          <p>
            Ein Design System ist eine „Digitale Bibliothek“. Sie beinhaltet
            klare Regeln, Prinzipien und wiederverwendbare Komponenten. Das
            Design System ist die „Single Source of Truth“ für die
            strategisch-gestalterische Ausrichtung einer Marke und/oder eines
            Produktes oder Services.
          </p>
          <p style="font-weight: 700">Das System im Einsatz</p>
          <p>
            Mithilfe einer Komponentenbibliothek bildet unser tokenbasiertes,
            integratives Design System eine einheitliche, wiederverwendbare
            sowie erweiterbare Basis für Ihre unterschiedlichsten
            Softwareprojekte.
          </p>
          <p>
            Das System wird direkt in den Entwicklungsprozess integriert.
            Dadurch können neue Applikationen automatisch und deckungsgleich
            erstellt, implementiert oder ergänzt werden.
          </p>
          <p>
      ...
      <section>
        <div style="width: 548px; margin: 0 auto; margin-top: 80px">
          ...
          <p>
            ...
            Design System umgehen, pﬂegen und erweitern kann. Dafür passen wir
            es genau an Ihre Bedürfnisse an.
          </p>
          <p>
            Wichtige Leitplanken sind dabei Checkup & Analyse der
            Designprozesse, TechStack Screening, Scoping des Projektes, die
            nahtlose Integration und das Coaching der Teams.
          </p>
        </div>
      </section>
      <section
